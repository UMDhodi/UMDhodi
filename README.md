...
ask_me:      Anything LLMs, Excel sorcery,
             or making dashboards that slap
superpower:  Turning a plain prompt into
             a polished product
```
...
![Microsoft Office](https://img.shields.io/badge/Microsoft_365-D83B01?style=for-the-badge&logo=microsoft-office&logoColor=white)
...
```
📌 AI-augmented workflows     — Prompt engineering • RAG pipelines • Claude artifacts
📌 Data dashboards            — Power BI reports with live data • Excel financial models
📌 Automation scripts         — GPT/Gemini API integrations • task automation
📌 Insight documents          — Turning raw data into C-suite-ready narratives
```
...
<details>
<summary>⚙️ How to activate the Contribution Snake (click to expand)</summary>
